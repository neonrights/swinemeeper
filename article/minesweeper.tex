...
\section{Conclusion}
To my knowledge there has been no previous work on designing and characterizing a globally optimal solver for Minesweeper.  However, as the experimental results indicate, a globally optimal solver barely performs better than
